...
public class PrenotazioneDettaglioRest {
	...
	PrenotazioneDettaglio add(@RequestBody PrenotazioneDettaglio pd) {
		return service.add(pd);
	}
	
	@PatchMapping("prenotazioni_dettaglio")
	PrenotazioneDettaglio update(@RequestBody PrenotazioneDettaglio pd) {
